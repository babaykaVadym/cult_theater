...
mixin _$UserInformationState {
  ...
  TResult when<TResult extends Object?>({
    required TResult Function(bool isLoading, User? user) initial,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult? whenOrNull<TResult extends Object?>({
    TResult? Function(bool isLoading, User? user)? initial,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
class _$InitialImpl implements _Initial {
  const _$InitialImpl({required this.isLoading, this.user});
  ...
  @override
  String toString() {
    return 'UserInformationState.initial(isLoading: $isLoading, user: $user)';
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return initial?.call(isLoading, user);
  }
...
abstract class _Initial implements UserInformationState {
  const factory _Initial({required final bool isLoading, final User? user}) =
      _$InitialImpl;
